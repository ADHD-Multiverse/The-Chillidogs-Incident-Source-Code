function onCreate()
	makeLuaText('miss2', 'shadow', 0, 180, 665)
	addLuaText('miss2')
	...
	makeLuaText('points2', 'shadow', 0, 180, 535)
	addLuaText('points2')
	...
	makeLuaText('timer', 'there', 0, 180, 597)
	addLuaText('timer')
...
if downscroll == true then
	makeLuaText('miss2', 'shadow', 0, 180, 165)
	addLuaText('miss2')
	setTextColor('miss2', '000000')
	
	makeLuaText('points2', 'shadow', 0, 180, 35)
	addLuaText('points2')
	setTextColor('points2', '000000')
	
	makeLuaText('timer2', 'shadow', 0, 180, 99)
	addLuaText('timer2')
	setTextColor('timer2', '000000')

	makeLuaText('miss', 'error', 0, 180, 160)
	addLuaText('miss')
	setTextColor('miss', 'FFFFFF')
	
	makeLuaText('points', 'error', 0, 180, 30)
	addLuaText('points')
	setTextColor('points', 'FFFFFF')
	
	makeLuaText('timer', 'error', 0, 180, 94)
	addLuaText('timer')
	setTextColor('timer', 'FFFFFF')
